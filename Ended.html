          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link active active_header" aria-current="page" href="./Ended.html">ENDED AUCTIONS</a>
                </li>
        ...
        <div class="row mt-5 justify-content-center">
          <div
            ...
            <div class="Auctions_products_cards text-center p-3">
              <!-- Products Images -->
              <img src="./assests/icons&images/image 40.png" alt="" class="img-fluid my-4" />
              <!-- Products Images -->
          ...
          <div
            ...
            <div class="Auctions_products_cards text-center p-3">
              <!-- Products Images -->
              <img src="./assests/icons&images/image 38.png" alt="" class="img-fluid my-4" />
              <!-- Products Images -->
          ...
          <div
            class="col-12 col-sm-9 col-md-6 col-xl-5 col-xxl-4  mb-5d-flex justify-content-center align-items-center">
            <!-- Products Cards -->
            <div class="Auctions_products_cards text-center p-3">
              <!-- Products Images -->
              <img src="./assests/icons&images/image 47.png" alt="" class="img-fluid my-4" />
              <!-- Products Images -->
