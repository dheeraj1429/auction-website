        ...
        <div class="container">
            ...
            <div class="row py-0 py-md-4">
                <div class="col-12">
                    ...
                    <h5 class="howitworks_para">Important notice : The minimum number of actual participants required
                        for
                        an
                    ...
                    <p class="howitworks_para">An innovative and original service which brings a new way of
                        understanding
                    ...
                    <p class="howitworks_para">To find out more, visit the official smartauction.com website, our
                        Facebook
                        page or
                        our
                        Instagram page.</p>
