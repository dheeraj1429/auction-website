        ...
        <div class="row g-3">
          ...
          <div class="col-12 col-sm-12 col-md-12 col-lg-6  ">
            ...
            <a target="_blank" href="buy-token.php"
              class="btn btn-lg rounded-pill h4 fw-bolder btn-danger buy_Button mb-5" name="enterAuction">Please top up
              your tokens</a>
            <?php } }else{ ?>
            ...
            <form method="POST">
              <button type="submit" class="btn btn-lg rounded-pill h4 fw-bolder btn-danger buy_Button mb-5 enterAuction"
                style="display:none;" name="participateAuction">
                Enter Auction
              </button>
            </form>
            <?php } }else{?>
            <a target="_blank" href="login.php?redirect=<?php echo $_SERVER['REQUEST_URI']?>"
              class="btn btn-lg rounded-pill h4 fw-bolder btn-danger buy_Button mb-5" name="enterAuction">Please Login
              to Enter Auction</a>
            <?php }?>
          </div>
        </div>
