          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link active active_header" aria-current="page" href="./currentAuctions.html">CURRENT
                    AUCTION</a>
                </li>
        ...
        <div class="row align-items-center pt-3">
          ...
          <div class="col-12 col-sm-12 col-md-6 col-lg-6 currentAuction_container1">
            ...
            <div class="currentAuction_heading">
              <h2 class="mb-0">iphone 6s plus pink</h2>
              <span class="currentAuction_line"></span>
            </div>
            <p class="currentAuction_container1-para2 mt-2">
              We are proud to offer you our hi-tech original goods. The products of our store are the real bestsellers
              and we have a great number of
              faithful customers. Their testimonials prove that the reputation of our company is simply perfect. We
              observe the policy of providing
              only branded commodities. This fact confirms that we sell only high quality goods at a fair price.
            </p>
            <p class="currentAuction_container1-para">Best Seller</p>
            <p class="currentAuction_container1-para3">Insted Of <del>$1100</del> <span>$248.99</span></p>
