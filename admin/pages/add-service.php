<?php 
    ...
    if(isset($_POST['submit'])){ 
        ...
        if(isset($_GET['id'])){
            ...
            $query="INSERT INTO `".$tblPrefix."cms_pages`(`type`, `title`, `desc`, `date_time`, `status`) VALUES (3,'$head','$text','$cTime',2)";
        ...
        if(mysqli_query($conn,$query)==true){
            ...
            if(file_exists($tmpName)){
                ...
                if($ext=='jpg' || $ext=='jpeg' || $ext=='png'){
                    ...
                    if(move_uploaded_file($tmpName, '../media/img/service/'.$fileName)==true){
                                    ...
                                    <div class="col-lg-12 mb-3">
                                        <form method="POST" enctype="multipart/form-data">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="head" placeholder="Heading" value="<?php if(isset($_GET['id'])){echo $dataS['title'];}?>" name="head" autocomplete="OFF" required="">
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label for="text">Text</label>
                                               <textarea id="trumbowyg" class="form-control" name="text"><?php if(isset($_GET['id'])){echo htmlspecialchars_decode($dataS['desc']);}?></textarea>
                                            </div>
                                            <div class="form-group col-md-12">
                                                ...
                                                <?php if(isset($_GET['id'])){?>
                                                    <br>
                                                    <img src="../media/img/service/<?php if(isset($_GET['id'])){echo $dataS['img'];}?>" class="img-circle img-responsive m-auto mx-2" alt="<?php if(isset($_GET['id'])){echo $dataS['title'];}?>" height="100px;">
                                                <?php }?>
                                            </div>
