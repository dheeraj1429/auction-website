                                        ...
                                        <div class="col-lg-6 m-b-30">
                                            <div class="card m-b-30 p-2" style="flex-direction:row;">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <a href="add-testimonial.php?id=<?php echo $data['id']?>" class="btn btn-primary">Edit</a>
                                                    
                                                    <a href="#" class="btn btn-danger delete-row" data-this-id="<?php echo $data['id']?>">Delete</a>
                                                    <span class="ml-5">
