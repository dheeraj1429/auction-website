                                        ...
                                        <div class="col-lg-5 my-2">
                                            <div class="card m-b-30">
                                                ...
                                                <div class="card-footer">
                                                    <a href="add-package.php?id=<?php echo $dataPackage['id']?>" class="btn btn-primary">Edit</a>
                                                    
                                                    <a href="#" class="btn btn-danger delete-row" data-this-id="<?php echo $dataPackage['id']?>">Delete</a>
