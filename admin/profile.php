...
// Profile
    if(isset($_POST['submit_profile'])){
        ...
        if($action == true){
            ...
            $_SESSION['adi']['phone']=$phone;
            $_SESSION['adi']['city']=$city;
            $_SESSION['adi']['state']=$state;
            $_SESSION['adi']['address']=$address;
            $_SESSION['adi']['designation']=$designation;
                                        ...
                                        <form method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="text-center">
                                                <label class="avatar-input"> 
                                                    <span class="avatar avatar-xl"> 
                                                        <img src="../media/img/users/<?php echo $_SESSION['adi']['img'];?>" alt="<?php echo $_SESSION['adi']['name'];?>" class="avatar-img rounded-circle"> 
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" value="<?php echo $_SESSION['adi']['designation'];?>" class="form-control" id="inputEmail6" placeholder="Designation" name="designation">
                                                </div>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="phone" placeholder="City" value="<?php echo $_SESSION['adi']['phone'];?>" name="phone">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="city">City</label>
                                                    <input type="text" class="form-control" id="city" placeholder="City" value="<?php echo $_SESSION['adi']['city'];?>" name="city">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="state">State</label>
                                                    <input type="text" class="form-control" id="state" placeholder="City" value="<?php echo $_SESSION['adi']['state'];?>" name="state">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputAddress">Address</label>
                                                <input type="text" class="form-control" id="inputAddress" placeholder="Address" value="<?php echo $_SESSION['adi']['address'];?>" name="address">
                                            </div>
