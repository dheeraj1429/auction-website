                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="name" placeholder="name" value="<?php echo $dataAuc['name'];?>" name="name" autocomplete="OFF" required="">
                                        </div>
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" name="storePrice" placeholder="Store Price" value="<?php echo $dataAuc['store_price'];?>" class="form-control" aria-label="Amount (to the nearest dollar)">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-12">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="capacity" placeholder="Capacity" value="<?php echo $dataAuc['capacity'];?>" name="capacity" autocomplete="OFF" required="">
                                        </div>
                                        <div class="form-group col-md-12">
