										...
										<div class="tab-pane fade show active" id="line-home" role="tabpanel" aria-labelledby="home-tab">
											<form method="POST" enctype="multipart/form-data">
												...
												<div class="form-row mb-3">
													<img src="<?php echo getValuesByName("logo"); ?>" class="img-circle img-responsive m-auto mx-2" alt="Logo" height="100px;">
											...
											<form method="POST" enctype="multipart/form-data">
												<div class="form-row mb-5">
													<img src="<?php echo getValuesByName("favicon") ?>" class="img-circle img-responsive m-auto mx-2" alt="Favicon" height="100px;">
													<div class="custom-file">
											...
											<form method="POST" enctype="multipart/form-data">
												...
												<div class="form-row">
													<div class="form-group col-lg-12">
														...
														<input type="type" class="form-control" id="sitename" placeholder="Site Name" name="site" value="<?php echo getValuesByName("website_name"); ?>">
													</div>
													<div class="form-group col-md-6">
														<label for="contactinput">Contact Number</label>
														<input type="type" class="form-control" id="contactinput" placeholder="Number" name="contact" value="<?php echo getValuesByName("phone_number"); ?>">
													</div>
													<div class="form-group col-md-6">
														<label for="inputemail">Email</label>
														<input type="email" class="form-control" id="inputemail" placeholder="Email" name="email" value="<?php echo getValuesByName("email"); ?>">
													</div>
													<div class="form-group col-md-6">
														<label for="mailerinout">Mailer Mail</label>
														<input type="email" class="form-control" id="mailerinout" placeholder="Mailer Mail" name="mailer" value="<?php echo getValuesByName("mailer_email"); ?>">
													</div>
													<div class="form-group col-md-6">
														<label for="addinput">Address</label>
														<input type="type" class="form-control" id="addinput" placeholder="Address" name="address" value="<?php echo getValuesByName("address"); ?>">
													</div>
												</div>
