               ...
               <div class="row">
                     ...
                     <div class="row">
                        <div class="col-10 m-auto">
                           <p class="text-center buy_tokens_para mt-2">
                              Smart-Auction Tokens are clicks you use to outbid standard auctions Please note that Standard Tokens are only valid for
                              standard auctions.
                           </p>
                        </div>
                     </div>
                  ...
                  <div class="col-12 zid_clicks mt-5">
                     <div class="row">
                        <div class="col-xxl-3 col-md-6 mb-5">
                           <div class="zid_click_card mx-2">
                              ...
                              <div class="zid_click_card_body text-center py-4">
                                 <p class="click_card_content text-center light_para px-5">The pack allows you to have 10 aditional clicks to bid.</p>
                        ...
                        <div class="col-xxl-3 col-md-6 mb-sm-5 mb-md-0">
                           <div class="zid_click_card mx-2">
                              <div class="zid_click_card_head text-center py-4">
               ...
               <div class="row">
                  <div class="col-12 mt-5">
                     ...
                     <div class="row">
                        <div class="col-10 m-auto">
                           <p class="text-center buy_tokens_para mt-2">
                              VIP Tokens are clicks you use to outbid during VIP auctions Please note that VIP Tokens are only valid for VIP auctions
                           </p>
                        </div>
                     </div>
                  </div>
                        ...
                        <div class="col-xxl-3 col-md-6 mb-5">
                           <div class="vip_click_card mx-2">
                              <div class="vip_click_card_head text-center py-4">
                                 <img src="./assets/icons&images/vip.png" alt="" class="vip_logo_img mb-3" />
                                 <h4 class="mb-0 text-white">10 CLICK PACK</h4>
                              </div>
